...
<div class="d-flex min-vh-100">
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <h1><i class="fas fa-chalkboard-teacher me-2"></i>Olevel Sujects Dashboard</h1>
            <p>Manage your subjects and assign grades to individual students</p>
        </div>

        <!-- Assigned Subjects -->
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fas fa-list-alt me-2"></i>My Assigned Subjects</h5>
                @php
                    $subjectCount = 0;
                    foreach($assignments as $assign) {
                        if($assign->class !== 'Form 5' && $assign->class !== 'Form 6') {
                            $subjectCount++;
                        }
                    }
                @endphp
                <span class="badge bg-primary rounded-pill">{{ $subjectCount }}</span>
            </div>
            <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="subject-details">
                                <span class="badge bg-light text-dark">{{ $assign->class }}</span>
                            </div>
                        </div>
                ...
                @endforelse
                @if(!$hasSubjects && count($assignments) > 0)
                    <li class="list-group-item empty-state">
                        <i class="fas fa-book-open"></i>
                        <div>No O-Level subjects assigned yet.</div>
                    </li>
                @endif
            </ul>
        </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">
                                ...
                                {{ $assign->subject->subject_name }} - {{ $assign->class }}
                            </h5>
