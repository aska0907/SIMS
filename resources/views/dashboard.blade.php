...
<div class="d-flex min-vh-100">
    ...
    <nav class="bg-primary text-white p-4 flex-shrink-0" style="width: 250px;">
        ...
        <ul class="nav flex-column mb-auto">
            ...
            <li class="nav-item mb-2">
                <a href="" class="nav-link text-white"><i class="fas fa-book me-2"></i> Subjects olevel</a>
            </li>
            <li class="nav-item mb-2">
    ...
    <div class="flex-grow-1 p-4">
        ...
        <div class="mb-4">
            ...
            <p class="text-muted">Manage your subjects and assign grades to individual students</p>
        </div>

        <!-- Assigned Subjects -->
        <div class="card mb-4">
            <div class="card-header"><h5 class="mb-0">My Assigned Subjects</h5></div>
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title">{{ $assign->subject->subject_name }} - {{ $assign->class }}</h5>
                            ...
                            <div class="tab-pane fade show active" id="sem1-{{ $assign->id }}">
                                <form method="POST" action="{{ route('grades.store') }}">
                                    ...
                                    <div class="text-end mt-2">
                                        <button type="submit" class="btn btn-success">Save Semester 1</button>
                                    </div>
                                </form>
                            </div>
